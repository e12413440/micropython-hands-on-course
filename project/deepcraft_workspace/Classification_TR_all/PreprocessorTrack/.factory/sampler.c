...
* 
* Generated at 02/16/2026 13:58:55 UTC. Any changes will be lost.
* 
* Memory    Size                      Efficiency
* State     19408 bytes (RAM)         100 %
* 
* Layer                          Shape           Type       Function
* Sliding Window (data points)   [600,6]         float      dequeue
*    window_shape = [600,6]
*    stride = 240
*    buffer_multiplier = 1
* Contextual Window (Sliding Window) [600,6]         float      dequeue
*    contextual_length_sec = 1.5
*    prediction_freq = 10
* 
* Exported functions:
* 
...
*    Parameter data_out is Output of size float[600,6].
...
// Working memory
static int8_t _state[19408];

// Memory mapped buffers
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[19408] (19408 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K5, data_out, 40, time_out));
    return 0;
}
